...
# Note: execute_javascript and inject_script_library have been removed
# Use unified tool: execute_script instead
# execute_automation_script is kept as it's not covered by unified tools
SCRIPT_TOOLS = [
    Tool(
